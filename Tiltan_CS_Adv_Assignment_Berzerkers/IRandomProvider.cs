...
namespace Tiltan_CS_Adv_Assignment_Berzerkers
{
    ...
    {
        public T GetRandom(string unitName);
    }

    public readonly struct NumberDice : IEquatable<NumberDice>, IRandomProvider<int>
    {
    ...
    public readonly struct Dice<T> : IRandomProvider<T> where T : IComparable<T>
    {
        ...
        public T GetRandom(string unitName = "Unknown Actor")
        {
            return Roll(unitName);
        }
        ...
        private T Roll(string unitName)
        {
            var result = 0;
    ...
    public readonly struct Bag : IRandomProvider<int>
    {
